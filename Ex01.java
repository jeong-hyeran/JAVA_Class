...
public class Ex01 {
	public static void main(String[] args) {
		int num; //[자료형] [변수이름]
		num = 12; //면수에 값을 저장, 왼쪽에 있으면 그릇 오른쪽에 있으면 값
...
//		int num = 25;	//이미 선언된 변수는 자료형을 명시하지 않는다.
		...
		num2 = num;	//대입연산의 좌변은 공간
					//대입연산의 우변은 값
//		System.out.println("num2 : " + num);	//num2 : 12
		
		num2 = num + 2 * 3 - 4;		// 우변부터 먼저 처리한다.
//		System.out.println("num2 : " + num2); // num2 : (12+2*3-4) 14
		
		num = 5;		// 대입연산자 '='는 등호가 아니다.
		// 5 = num;		// 등호는 '=='로 표기한다. 왼쪽에 변수가 들어와야해서 값이 왼쪽에 오면 에러뜬다.
