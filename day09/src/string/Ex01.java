...
public class Ex01 {
	public static void main(String[] args) {
		...
		// s1.compareTo(String anotherString)
		// 문자열을 다른 문자열과 비교하여 대소관계를 정수로 반환한다.
		
		// String s1 = "Hello, World !!";
		// [72, 101, 108, 108, 111]
		char[]arr1 = {72, 101, 108, 108, 111};
		char[]arr2 = {104, 101, 108, 108, 111}; // 32더하면 대문자로 변경
		...
		System.out.println("Hello.equalsIgnoreCase(He) : " + "Hello".equalsIgnoreCase("hello"));	
		/// 대소문자 무시하고 일치여부 확인
		...
		boolean b5 = "Hello".equalsIgnoreCase("hello");	// 명령어 대소문자 구분 없이 실행
		...
		System.out.println("Hello.equalsIgnoreCase(He) : " +b5);	
	}
